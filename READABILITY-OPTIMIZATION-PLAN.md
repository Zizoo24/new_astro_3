...
For each page:
- Shorten sentences (target: 15-20 words max)
- Replace complex words with simpler alternatives
- Add bullet lists where appropriate
- Ensure clear subheadings break up content
- Maintain brand voice per CLAUDE.md guidelines
